...
<!-- Figure 1 -->
<object data="graphics/Handshake.pdf" type="application/pdf" width="700px" height="500px">
    <embed src="graphics/Handshake.pdf" type="application/pdf" />
    <p>This browser does not support PDFs. Please download the PDF to view it: <a href="graphics/Handshake.pdf">Download PDF</a>.</p>
</object>
...
<!-- Figure 2 -->
<object data="graphics/4PhaseProtocol.pdf" type="application/pdf" width="700px" height="500px">
    <embed src="graphics/4PhaseProtocol.pdf" type="application/pdf" />
    <p>This browser does not support PDFs. Please download the PDF to view it: <a href="graphics/4PhaseProtocol.pdf">Download PDF</a>.</p>
</object>
