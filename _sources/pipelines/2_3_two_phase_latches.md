...
In some cases, we will be able to make use of the extra time provided by the latch, borrowing time from the next stage. `Chapter 2.5` will explore how this technique can lead to faster designs.
