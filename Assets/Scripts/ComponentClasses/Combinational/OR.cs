...
public class OR : CircuitComponent, IDelay
{
    ...
    private void OnTickDelay(int tick){
        ...
        if(!A.EqualsToken(lastA) || !B.EqualsToken(lastB)){
            ...
            signalQueue.Add(new SignalEntry(or,(GameObject)null));
        }
    ...
    private void OnTickVisualizeDelay(int tick){
        ...
        if(!A.EqualsToken(lastA) || !B.EqualsToken(lastB)){
            ...
            //add result to queue: 
            GameObject square = DelayHandler.NewSquare(0,or.ActiveColor(),delayVisualizer,tick);
            signalQueue.Add(new SignalEntry(or,square));
        }
    ...
    {
        GameObject prefab = Resources.Load("Prefabs/OR") as GameObject;
    ...
    public void DelayInit(){
        ...
        signalQueue.Add(new SignalEntry(initSignal,square));
