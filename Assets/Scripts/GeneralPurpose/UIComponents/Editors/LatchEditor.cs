...
public class LatchEditor : MonoBehaviour
{
    private Latch l;    //edited clock
    private TMP_InputField setup;
    private TMP_InputField hold;
    private TMP_InputField delay;
    private ButtonLatchDelay delayVisualizeButton;
    ...
    void Awake()
    {
        ...
        delayVisualizeButton = o.GetComponent<ButtonLatchDelay>();
