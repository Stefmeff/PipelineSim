...
public class ButtonLatchDelay : MonoBehaviour, IPointerDownHandler, IPointerEnterHandler, IPointerExitHandler
{
    //global boolean for displaying delay
    public bool showDelay = false;

    //Delay Editor
    private LatchEditor latchEdit;
    ...
    void Awake()
    {
        ...
        latchEdit = o.GetComponent<LatchEditor>();
    }
    ...
    public void UpdateButton(){
        ...
        latchEdit.VisualizeDelay(showDelay);    
    }
