...
public class ButtonCPDelay : MonoBehaviour, IPointerDownHandler, IPointerEnterHandler, IPointerExitHandler
{
    //global boolean for displaying delay
    public bool showDelay = false;

    //Delay Editor
    private CPLatchEditor cpEdit;
    ...
    void Awake()
    {
        ...
        cpEdit = o.GetComponent<CPLatchEditor>();
    }
    ...
    public void UpdateButton(){
        ...
        cpEdit.VisualizeDelay(showDelay);    
    }
